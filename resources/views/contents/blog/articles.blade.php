<article class="uk-article">
    ...
    <p>
        <a class="uk-button uk-button-primary" href="/post">Continue Reading</a>
        <a class="uk-button" href="/post">4 Comments</a>
    </p>
